/*
   Delay Minute (new method) Example for FCGF Library (Google Form for all Wi-Fi Boards)
   Documentation here :
...
int num_of_inputs;
int submit_delay = 1; //wait 1 minute
...
void loop()
{
  ...
  //Submit data after 2 minutes to Google Form gf.submit(privateid,arrayinputs,arrayvalues,numofinputs,submitdelay);
